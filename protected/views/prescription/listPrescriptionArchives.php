...
<div class="col-xl-12 col-lg-12">
	<div class="card shadow mb-4">
	    <div class="card-header py-3">
	        <h6 class="m-0 font-weight-bold text-primary">Prescription Archives</h6>
	    </div>
	    <div class="card-body">
	    	 <div class="table-responsive">
			    ...
			    <?php endif; ?>
	    	 	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	                ...
	                <tbody>
						<?php 
							foreach($listOfPrescriptionArchives as $modelValue)
							{
						?>
								<tr>
									...
									<?php 
									echo "<td class='text-center'>".CHtml::link('<i class="fas fa-info-circle"></i>', $this->createAbsoluteUrl('prescription/view/'.$modelValue->id), array('class'=>'btn btn-info btn-circle btn-sm'))."</td>";
