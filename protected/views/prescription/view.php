	                ...
	                <tbody>
						...
						?>
								<tr>
									...
									<?php 
										echo "<td class='text-center'>".CHtml::link('<i class="fas fa-info-circle"></i>', $this->createAbsoluteUrl('consultationRecord/view/'.$modelValue->consultation->id), array('class'=>'btn btn-info btn-circle btn-sm'))."</td>";
									?>
								</tr>
						<?php		
							}
