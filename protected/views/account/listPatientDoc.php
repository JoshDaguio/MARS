	                ...
	                <tbody>
						...
						?>
								<tr>
									...
									<?php 
                                    echo "<td class='text-center'>".CHtml::link('<i class="fas fa-plus"></i>', array('consultationRecord/CreateConsultationAndPrescription/', 'patientId' => $modelValue->patientAccount->id), array('class' => 'btn btn-info btn-circle btn-sm')) . "</td>";
									echo "<td class='text-center'>".CHtml::link('<i class="fas fa-thumbtack"></i>', array('immunizationRecord/createImmunizationRecordDoc/', 'patientId' => $modelValue->patientAccount->id), array('class' => 'btn btn-info btn-circle btn-sm')) . "</td>";
									echo "<td>" . CHtml::link('<i class="fas fa-info-circle"></i>', array('account/ViewAccountForDoctor', 'id' => $modelValue->patientAccount->id), array('class' => 'btn btn-info btn-circle btn-sm')) . "</td>"; 
									?>
								</tr>
