<div class="row">
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <img src="/MARS/images/patientprof.png" alt="Super Admin" style="height: auto; width: auto; margin-left: 10px;">
        </div>
    </div>
    ...
    <div class="col-xl-12 col-lg-12">
        <?php foreach($listofAccounts as $modelValue): ?>
            <div class="card shadow mb-4 text-center">
                ...
                <div class="card-body">
                    <p class="mx-2">
                        Edit Your Profile <?php echo CHtml::link('<i class="fas fa-edit"></i>', $this->createAbsoluteUrl('account/updatePatientProfile/'.$modelValue->id),array('class'=>'btn btn-success btn-circle btn-sm'));?>
                    </p>
